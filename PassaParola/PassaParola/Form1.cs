...
namespace PassaParola
{
    public partial class Form1 : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (soruno == 5)
            {
                richTextBox1.Text = "yeni kelimesini zıt anlamlısı?";
            ...
            if (soruno == 13)
            {
                richTextBox1.Text = "Heryıl bahar aylarında gerçekleşen çiçek festivali?";
            ...
            if (soruno == 19)
            {
                richTextBox1.Text = "yılan kelimesinin ingilizcesi?";
            ...
            if (soruno == 24)
            {
                richTextBox1.Text = "ege bölgesinin en çok ağacı bulunan ve yağı yapılan bir kahvaltı besini?";
